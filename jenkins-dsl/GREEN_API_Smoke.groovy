pipelineJob('QA-Automation/MERITO/GREEN_API_Smoke') {
    parameters {
                      ...
                      stage ('Run') {
                        steps {
                          container(name: 'automation') {
                            ...
                            sh '''xvfb-run --server-args="-screen 0 1920x1080x24" java -cp '/home/automation/target/classes/:/home/automation/target/dependency/*' org.testng.TestNG /home/automation/src/main/api/smoke/green/PRO_API.xml'''
                          }
                        }
                      }
                    }
