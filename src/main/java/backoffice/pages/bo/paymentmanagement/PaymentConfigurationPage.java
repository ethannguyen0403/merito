...
public class PaymentConfigurationPage extends HomePage {
    ...
    String btnRemoveXpath = "//div[text()=' %s ']/parent::div//span[@class='cursor-pointer p-2'][1]";
    String btnEyeXpath = "//div[text()=' %s ']/parent::div//span[@class='cursor-pointer p-2'][2]";
    ...
    Popup ppLogXpath = Popup.xpath("//modal-container");
    ...
    public int colUsername = 4;
    public int colUpdatedDate = 9;
    ...
    public void clickToRemoveByUsername(String username) {
        Button btnRemoveByUsername = Button.xpath(String.format(btnRemoveXpath,username));
    ...
    public PaymentConfigurationPopup clickToViewLogByUsername(String username) {
        Button btnViewLog = Button.xpath(String.format(btnEyeXpath,username));
    ...
    public boolean isDisplayLogPopup(){
        ...
        return ppLogXpath.isDisplayed(3);
    }
