...
public class PersonalMessageTest extends BaseCaseTest {
    /**
    ...
    public void BO_Operations_Personal_Message_001(String satSADAgentLoginID, String memberPassword) throws Exception {
     ...
     /*   baseTest.BaseCaseTest.loginAgent(environment.getSatAgentSOSURL(),environment.getSatAgentSecurityCodeUrl(),satSADAgentLoginID,memberPassword,environment.getSecurityCode());
