...
public class WagerVoidUnvoidTest extends BaseCaseMerito{

    /**
     * @title: Validate can search void/un-void wager by Wager ID
     * @pre-condition:
     *           1.Login member and search any wager settled
     *          2.Login BO
     ...
     * @pre-condition:
     *          1.Login member and search any wager settled and get place date
     *          2.Login BO
     * @steps:  1. Access Operations > Wager Void/Un-void
     *          2. Select void by Wager
     *          3. Select Exchange Product
     ...
     * @pre-condition:
     *         1.Login member and search any wager settled and get the info: Sport, Competition, Event of that wager
     *          2.Login BO
     * @steps:  1. Access Operations > Wager Void/Un-void
     *          2. Select void by Wager
     *          3. Select Exchange Product
     ...
     * @pre-condition:
     *         1.Login member and search any wager settled and get market id
     *          2.Login BO
     * @steps:  1. Access Operations > Wager Void/Un-void
     *          2. Select void by Wager
     *          3. Select Exchange Product
     ...
     * @pre-condition:
     *         1.Login member and search any wager settled and get the current balance and exposure of the account
     *          2.Login BO
     * @steps:  1. Access Operations > Wager Void/Un-void
     ...
     * @pre-condition:
     *         1.Login member and have a matched bet on a market , get balance and exposure of the account
     *         2.Login BO
     * @steps:  1. Access Operations > Wager Void/Un-void
     *          2. Select void by, Wager and search by wager
     *          3. Click on void and enter remark then click Void
