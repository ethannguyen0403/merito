 ...
 */
public class OwlDateTimePicker extends BaseElement {
    ...
    private OwlDateTimePicker(TextBox txtBox, By locator, String xpath) {
        super(locator);
        txtDate = txtBox;
        _xpath = xpath;
        ...
        btnPrevious = Button.xpath(String.format("%s//%s", _xpath, "button[contains(@aria-label,'Previous')]"));
        btnNext = Button.xpath(String.format("%s//%s", _xpath, "button[(@aria-label,'Next')]"));
    ...
    public static OwlDateTimePicker xpath(TextBox txtBox, String xpathExpression) {
        return new OwlDateTimePicker(txtBox, By.xpath(xpathExpression), xpathExpression);
    }
