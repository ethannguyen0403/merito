...
import agentsite.pages.all.agentmanagement.EventBetSizeSettingsPage;
...
import static agentsite.common.AGConstant.AgencyManagement.EventBetSiteSetting.*;
import static agentsite.common.AGConstant.*;
import static agentsite.common.AGConstant.HomePage.*;

public class EventBetSizeSettingsTest extends BaseCaseMerito {
    /**
    ...
    public void Agent_AM_Event_Bet_Site_Settings_002() {
        ...
        Assert.assertEquals(page.getPageTitle(), EVENT_BET_STIE_SETTINGS, "FAILED! Page Title is incorrect");
    ...
    public void Agent_AM_Event_Bet_Site_Settings_004() {
        ...
        log("Step 1. Navigate Agency Management > Event Bet Size Settings");
        List<String> lstLeftMenu = agentHomePage.leftMenuList.getListSubMenu(AGENCY_MANAGEMENT);
   ...
   //     List<String> betSettingInfo = EventBetSizeSettingUtils.getUserBetSetting("EXCHANGE",acc.getUserID(),"SOCCER");
      ...
      /*  page.logout();
        ...
        page = agentHomePage.clickSubMenu(AGENCY_MANAGEMENT, EVENT_BET_STIE_SETTINGS, EventBetSizeSettingsPage.class);
        page.filter("", "Soccer", "Today");
        page.searchEventInfo("","", event.getID());
        page.updateMinMax(event.getID(), "Exchange","","");
    ...
    public void Agent_AM_Event_Bet_Site_Settings_027() {
        ...
        DialogPopup popup = page.openErrorPopup(eventId,"Exchange");
    ...
    public void Agent_AM_Event_Bet_Site_Settings_029(String memberAccount, String password,String downlineAccount) throws Exception {
      log("@title:Cannot place bet when stake less than min setting in Event Bet Site Setting for normal market");
        ...
        blockUnblockEventPage.filter("",sportName, AGConstant.MarketsManagement.BlockUnblockEvent.TAB_DAYS.get(2));
        ...
        sportPage.betSlipControl.placeBet(odds, Integer.toString(min));
