...
import static agentsite.common.AGConstant.HomePage.BIG_STAKE_CONFIGURATION;
import static agentsite.common.AGConstant.HomePage.REPORT;

public class BigStakeConfigurationTest extends BaseCaseMerito {
    /**
    ...
    public void Agent_Report_Big_Stake_Configuration_001(){
        ...
        agentHomePage.clickSubMenu(REPORT, BIG_STAKE_CONFIGURATION, BigStakeConfigurationPage.class);
    ...
    public void  Agent_Report_Big_Stake_Configuration_002(){
        ...
        log("Step 1. Navigate Report > Top Gainers & Top Losers > Big Stake Configuration");
        BigStakeConfigurationPage page = agentHomePage.clickSubMenu(REPORT, BIG_STAKE_CONFIGURATION, BigStakeConfigurationPage.class);
