...
public class TopGainersTopLosersTest extends BaseCaseMerito {
    ...
    public void  Agent_Report_Top_Gainers_Top_Losers_002 (){
        ...
        String today = DateUtils.getDate(0,"MM/dd/yyyy", AGConstant.timeZone);
        ...
        Assert.assertEquals(page.btnSearch.getAttribute("value"),AGConstant.Report.TopGainersTopLosers.BTN_SEARCH, "FAILED! Search button text is incorrect ");
        ...
        ArrayList<String> aaa = page.tblBigStake.getHeaderNameOfRows();
