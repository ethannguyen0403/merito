...
public class AnalysisOfRunningMarketsTest extends BaseCaseMerito {
    ...
    public void Agent_Report_Analysis_Of_Running_Markets_001(){
        ...
        agentHomePage.clickSubMenu(REPORT, ANALYSIS_OF_RUNNING_MARKETS, AnalysisOfRunningMarketsPage.class);
    ...
    public void Agent_Report_Analysis_Of_Running_Markets_003(){
        ...
        String totalBet = lsMarket.get(0).get(3);
        ...
        List<ArrayList<String>> downlineList = page.tblDownline.getRowsWithoutHeader(true);
        String expecteMarketInfoTitle = String.format("%s (%s) | %s | Total %s Clients Are Working",competitionEventName,eventStarttime,marketName, downlineList.size());
