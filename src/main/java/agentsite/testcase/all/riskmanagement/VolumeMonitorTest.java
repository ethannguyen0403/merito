...
import static agentsite.common.AGConstant.HomePage.VOLUME_MONITOR;
import static agentsite.common.AGConstant.MarketsManagement.BlockedUserPopup.LBL_EVENT;
import static agentsite.common.AGConstant.NO_RECORD_FOUND;
import static agentsite.common.AGConstant.RiskManagement.VolumeMonitor.*;


public class VolumeMonitorTest extends BaseCaseMerito {
    /***
    ...
    public void Agent_RM_VolumeMonitorTest_TC001() {
        ...
        VolumeMonitorPage page = agentHomePage.clickSubMenu(RISK_MANAGEMENT,VOLUME_MONITOR, VolumeMonitorPage.class);

        log("Verify 1 Verify UI is correctly displayed");
        Assert.assertEquals(page.getPageTitle(),VOLUME_MONITOR,"FAILED! Volume Monitor page title is incorrect");
