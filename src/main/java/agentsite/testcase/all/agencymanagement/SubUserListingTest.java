...
public class SubUserListingTest extends BaseCaseMerito {
      /**
    ...
    public void Agent_AM_Sub_User_Listing_001() {
        ...
        log("Step 1. Navigate Agency Management > Sub User Listing");
        log("Step 2. Click on Create button");
        agentHomePage.navigateSubUserListing();
    ...
    public void Agent_AM_Sub_User_Listing_007(String password) throws Exception {
        ...
        Assert.assertTrue(agentHomePage.leftMenuList.isMenuDisplay(REPORT), "FAILED! Report menu does not display");
        Assert.assertFalse(agentHomePage.leftMenuList.isMenuDisplay(AGENCY_MANAGEMENT), "FAILED! Agency Management menu does not display");
        Assert.assertFalse(agentHomePage.leftMenuList.isMenuDisplay(MARKET_MANAGEMENT), "FAILED! Markets Management menu does not display");
    ...
    public void Agent_AM_Sub_User_Listing_008(String password) throws Exception {
        ...
        Assert.assertFalse(agentHomePage.leftMenuList.isMenuDisplay(REPORT), "FAILED! Report menu does not display");
        Assert.assertTrue(agentHomePage.leftMenuList.isMenuDisplay(AGENCY_MANAGEMENT), "FAILED! Agency Management menu does not display");
        Assert.assertFalse(agentHomePage.leftMenuList.isMenuDisplay(MARKET_MANAGEMENT), "FAILED! Markets Management menu does not display");
    ...
    public void Agent_AM_Sub_User_Listing_009(String password) throws Exception {
        ...
        List<String> lstSubMennu = agentHomePage.leftMenuList.getListSubMenu(MARKET_MANAGEMENT);
        ...
        Assert.assertFalse(agentHomePage.leftMenuList.isMenuDisplay(REPORT), "FAILED! Markets Management menu does not display");
        Assert.assertFalse(agentHomePage.leftMenuList.isMenuDisplay(AGENCY_MANAGEMENT), "FAILED! Markets Management menu does not display");
