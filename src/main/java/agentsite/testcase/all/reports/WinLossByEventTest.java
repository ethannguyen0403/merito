...
import static agentsite.common.AGConstant.HomePage.WIN_LOSS_BY_EVENT;

public class WinLossByEventTest extends BaseCaseMerito {
    /**
    ...
    public void Agent_Report_Win_Loss_By_Event_001(){
        ...
        agentHomePage.clickSubMenu(REPORT, WIN_LOSS_BY_EVENT, WinLossByEventPage.class);
    ...
    public void Agent_Report_Win_Loss_By_Event_002(){
        ...
        log("Step 1. Navigate Report >  Win Loss By Event");
        WinLossByEventPage page = agentHomePage.clickSubMenu(REPORT, WIN_LOSS_BY_EVENT, WinLossByEventPage.class);
        ...
        Assert.assertEquals(page.lblPageTitle.getText().trim(), AGConstant.Report.WinLossByEvent.LBL_TITLE,"FAILED! Incorrect default date in search from textbox");
