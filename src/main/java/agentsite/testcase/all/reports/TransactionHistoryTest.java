...
import static agentsite.common.AGConstant.Report.TransactionHistory.TABLE_HEADER;
...
public class TransactionHistoryTest extends BaseCaseMerito {
    ...
    public void  Agent_Report_Transaction_History_002 (){
        ...
        Assert.assertEquals(page.getPageTitle(),TRANSACTION_HISTORY,"Failed! Page title is incorrect");
