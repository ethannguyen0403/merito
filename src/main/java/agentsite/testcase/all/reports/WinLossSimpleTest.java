...
import static agentsite.common.AGConstant.Report.WinLossSimple.TABLE_HEADER;
...
public class WinLossSimpleTest extends BaseCaseMerito {
    ...
    public void Agent_Report_WinLossSimple_002(){
        ...
        Assert.assertEquals(page.getPageTitle(),WIN_LOSS_SIMPLE,"Failed! Page title is incorrect");
