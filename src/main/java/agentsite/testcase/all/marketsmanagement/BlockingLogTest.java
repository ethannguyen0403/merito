...
public class BlockingLogTest extends BaseCaseMerito {
    /**
    ...
    public void Agent_MM_Blocking_Log_TC002() {
        ...
        BlockingLogPage page = agentHomePage.clickSubMenu(MARKET_MANAGEMENT, BLOCKING_LOG, BlockingLogPage.class);
