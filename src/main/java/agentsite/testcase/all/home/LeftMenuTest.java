...
import agentsite.pages.all.components.QuickSearchComponent.QuickSetting;
...
public class LeftMenuTest extends BaseCaseMerito {
    ...
    public void LeftMenu_TC002(){
        ...
        Assert.assertEquals(agentHomePage.tabQuickSearch.getText(),QUICK_SEARCH,"FAILDE! Quick Search button is incorrect");
        ...
        Assert.assertTrue(quickSearchPage.txtQuickSearch.isDisplayed(),"FAILED! Quịck Search textbox does not display");
        Assert.assertEquals(quickSearchPage.btnSearchQuickSearch.getText(),BTN_SUBMIT,"FAILED! Quịck Search textbox does not display");
    ...
    public void LeftMenu_TC003(){
        ...
        Assert.assertEquals(agentHomePage.tabMainMenu.getText(),MAIN_MENU,"Failed! Quick Search tab is incorrect displayed");
        Assert.assertEquals(agentHomePage.tabQuickSearch.getText(),QUICK_SEARCH,"Failed! Quick Search tab is incorrect displayed");

        log("Verify: 2. A menu in Main menu display to verify Main menu is active by default");
        List<String> lstSubReprotMenu = agentHomePage.leftMenuList.getListSubMenu(AGENCY_MANAGEMENT);
    ...
    public void LeftMenu_TC004(){
        log("@title: Validate can expand/collapse Agency Management");
        log("Step:1 Click on Agency Management collapse");
        agentHomePage.leftMenuList.collapsedMenu(AGENCY_MANAGEMENT);

        log("Verify: 1. Agency Management collapsed");
        Assert.assertFalse(agentHomePage.isMenuExpanded(AGENCY_MANAGEMENT),"FAILED! The menu not collapsed");
        ...
        Assert.assertTrue(agentHomePage.isMenuExpanded(AGENCY_MANAGEMENT),"FAILED! The menu not collapsed");
    ...
    public void LeftMenu_TC008(){
        ...
        Assert.assertTrue(agentHomePage.isMenuExpanded(MARKET_MANAGEMENT),"FAILED! The menu not expanded");
        ...
        agentHomePage.leftMenuList.collapsedMenu(MARKET_MANAGEMENT);

        log("Verify 1: Can Collapse Market Management");
        Assert.assertFalse(agentHomePage.isMenuExpanded(MARKET_MANAGEMENT),"FAILED! The menu is not collapsed");
     ...
     * @expect:
     * 1 Verify account info and his direct update display
     * (e.g (1) AD   0GU (smaag1)
    ...
    public void LeftMenu_TC009(){
        ...
        QuickSearch quickSearchPage =agentHomePage.switchQuickSearch();
        quickSearchPage.quickSearch(accountDisplay);

        log("Verify 1 Verify account info and his direct update display");
        Assert.assertEquals(quickSearchPage.lblLevelQS.getText(),ProfileUtils.convertDownlineByBrand(downlineLevel,ProfileUtils.getAppName()),"FAILED! Level in quick search is incorrect displayed");
        Assert.assertEquals(quickSearchPage.lblAccountQS.getText(),accountDisplay,"FAILED! Account display in quick search incorrect");

        log("Verify 2. Verify all report display : Balance, Unsettled Bet, Client Ledger, Settings, Login");
        List<String> lstQuickSearchMenu = quickSearchPage.mtQuickSearchMenu.getListSubMenu();
    ...
    public void LeftMenu_TC010(){
        ...
        log("Step:3. Click Submit button");
        QuickSearch quickSearchPage =agentHomePage.switchQuickSearch();
        quickSearchPage.quickSearch(inDirectDownline.getUserCode());

        log("Verify 1 Verify account info and his direct update display");
        Assert.assertEquals(quickSearchPage.lblLevelQS.getText(),ProfileUtils.convertDownlineByBrand(directDownline.getLevel(),ProfileUtils.getAppName()),"FAILED! Level in quick search is incorrect displayed");
        Assert.assertEquals(quickSearchPage.lblAccountQS.getText(),directAccountDisplay,"FAILED! Account display in quick search incorrect");
        Assert.assertEquals(quickSearchPage.lblLevelIndrectQS.getText(),ProfileUtils.convertDownlineByBrand(inDirectDownline.getLevel(),ProfileUtils.getAppName()),"FAILED! Level in quick search is incorrect displayed");
        Assert.assertEquals(quickSearchPage.lblAccountIndrectQS.getText(),indirectAccountDisplay,"FAILED! Account display in quick search incorrect");
    ...
    public void LeftMenu_TC011(){
        ...
        QuickSearch quickSearchPage =agentHomePage.switchQuickSearch();
        quickSearchPage.quickSearch(directDownline.getUserCode());

        log("Step:1. Verify Balance Page displayed");
        Table tblBalance = quickSearchPage.clickBalance();
    ...
    public void LeftMenu_TC012(){
        ...
        DownLineListingPage downLineListingPage = quickSearchPage.clickDownLineListing();

        log("Verify 1. Verify Downline Listing page is displayed");
        Assert.assertEquals(downLineListingPage.lblPageTitle.getText(),DOWNLINE_LISTING,"FAILED! Page title is incorrect displayed");
    ...
    public void LeftMenu_TC013(){
        ...
        ProfitAndLossPage profitAndLossPage = quickSearchPage.clickProfitAndLoss();

        log("Verify 1. Verify Profit & Loss page is displayed");
        Assert.assertEquals(profitAndLossPage.lblPageTitle.getText(),PROFIT_AND_LOSS,"FAILED! Page title is incorrect displayed");
    ...
    public void LeftMenu_TC014(){
        ...
        ClientLedgerPage clientLedgerPage = quickSearchPage.clickClientLedger();

        log("Verify 1. Verify Client Ledger page is displayed");
        Assert.assertEquals(clientLedgerPage.lblPageTitle.getText(),CLIENT_LEDGER,"FAILED! Client Ledger title page is incorrect displayed");
    ...
    public void LeftMenu_TC016(){
        ...
        QuickSetting quickSetting = quickSearchPage.clickSetting();
    ...
    public void LeftMenu_TC015(){
        ...
        Table tblLogin = quickSearchPage.clickLogin();
    ...
    public void LeftMenu_TC017(){
        ...
        quickSearchPage.switchMainMenu();
        DownLineListingPage downLineListingPage = agentHomePage.clickSubMenu(AGENCY_MANAGEMENT, DOWNLINE_LISTING, DownLineListingPage.class);
        ...
        quickSearchPage = downLineListingPage.switchQuickSearch();
        quickSearchPage.quickSearch(directDownline.getUserCode());
        quickSearchPage.clickSetting().updateStatus("Active").close();
    ...
    public void LeftMenu_TC019() {
        ...
        agentHomePage.leftMenuList.expandMenu(RISK_MANAGEMENT);
        List<String> lstRiskManagement = agentHomePage.leftMenuList.getListSubMenu(RISK_MANAGEMENT);
...
//        Assert.assertFalse(lstReport.get(2),"Failed! Position Taking Report not display correctly");
    ...
    public void LeftMenu_TC022(){
        ...
        quickSearchPage.updateStatus(directDownline.getUserCode(),"Suspended",true);
        ...
        agentHomePage.switchQuickSearch().updateStatus(directDownline.getUserCode(),"Active",true);

        log("INFO: Executed completely");
    }

    @Test (groups = {"interaction"})
    public void LeftMenu_TC023() throws Exception {
        ...
        quickSearchPage.updateUserProfile("","", firstName,lastName,mobile,"","",true);
