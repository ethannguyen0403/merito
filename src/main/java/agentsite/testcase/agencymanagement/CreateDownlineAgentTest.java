...
//
     ...
     * @pre-condition: 1. Log in successfully with Cash Account
     * @steps: 1. Navigate Agency Management > Create Downline Agent
     ...
     * @pre-condition: 1. Log in successfully with Credit Cash Account
     * @steps: 1. Navigate Agency Management > Create Downline Agent
     ...
     * @pre-condition: 1. Log in successfully with Credit Account
     * @steps: 1. Navigate Agency Management > Create Downline Agent
