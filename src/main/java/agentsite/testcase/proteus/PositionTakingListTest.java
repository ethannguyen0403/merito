...
public class PositionTakingListTest extends BaseCaseTest {
    ...
    public void PS38_Agent_TC4081(String downlineAccount) {
        ...
        page.positionTakingListingPS38.search(downlineAccount, "", PS38, ALL, "");
        log("Step 4. Update level Preset for any downline level of Soccer sort");
        int ptAmount = 10;
        page.positionTakingListingPS38.updatePT(downlineAccount, "Preset", "" + ptAmount);
        log("Verify 1: Success icon is displayed");
        Assert.assertTrue(page.positionTakingListingPS38.verifyUpdateStatus(downlineAccount, true), "FAILED! Success icon is not displayed");
        ...
        Assert.assertEquals(new HashSet<>(page.positionTakingListingPS38.getPTAccountListByRow(downlineAccount, levelPreset)), new HashSet<>(
    ...
    @Test(groups = {"ps38", "Proteus.2024.V.1.0"})
    @Parameters({"downlineAccount"})
    public void PS38_Agent_TC4082(String downlineAccount) {
        ...
        page.positionTakingListingPS38.search(downlineAccount, "", PS38, LBL_SOCCER_SPORT, GENERAL);
        log("Step 4. Update level Preset for any downline level of Soccer sort");
        int ptAmount = 10;
        page.positionTakingListingPS38.updatePT(downlineAccount, "Preset", "" + ptAmount);
        log("Verify 1: Success icon is displayed");
    ...
    @Test(groups = {"ps38", "Proteus.2024.V.1.0"})
    @Parameters({"downlineAccount"})
    public void PS38_Agent_TC4083(String downlineAccount) {
        ...
        page.positionTakingListingPS38.search(downlineAccount, "", PS38, LBL_SOCCER_SPORT, "1");
        log("Step 4. Update level Preset for any downline level of Soccer sort");
        int ptAmount = 10;
        page.positionTakingListingPS38.updatePT(downlineAccount, "Preset", "" + ptAmount);
        log("Verify 1: Success icon is displayed");
    ...
    @Test(groups = {"ps38", "Proteus.2024.V.1.0"})
    @Parameters({"downlineAccount"})
    public void PS38_Agent_TC4084(String downlineAccount) {
    ...
    @Test(groups = {"ps38", "Proteus.2024.V.1.0"})
    @Parameters({"downlineAccount"})
    public void PS38_Agent_TC4085(String downlineAccount) {
    ...
    @TestRails(id = "4086")
    @Test(groups = {"ps38", "Proteus.2024.V.1.0"})
    @Parameters({"downlineAccount", "dowlineLevel"})
    public void PS38_Agent_TC4086(String downlineAccount, String dowlineLevel) {
        log("@title: Validate 'Min Pos', 'Max Pos', '[logged-in level] Preset' and '[logged-in level] Extra PT' dropdowns of direct downline");
        log("Step 1. Navigate Agency Management > Position Taking Listing");
        PositionTakingListingPage page = agentHomePage.navigatePositionTakingListingPage();

        log("Step 2. Filter with any player and PS38 product");
        page.positionTakingListingPS38.search(downlineAccount, "", PS38, "", "");
