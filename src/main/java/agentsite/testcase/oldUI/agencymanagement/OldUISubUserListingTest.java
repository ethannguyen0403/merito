...
public class OldUISubUserListingTest extends BaseCaseMerito {
      /**
    ...
    @Test (groups = {"smoke"})
    @Parameters("password")
    public void Agent_AM_Sub_User_Listing_OldUI_0004(String password) throws Exception {
        ...
        SubUserListingPage page = agentHomePage.clickSubMenu(AGENCY_MANAGEMENT, SUB_USER_LISTING, SubUserListingPage.class);
