...
public class FairenterUILeftMenu extends LeftMenu {
    ...
    public boolean isListSubMenuDisplayCorrect(String menu) {
        if(menu.equals(AGENCY_MANAGEMENT)){
            ...
            return lstSubMenu.equals(AGConstant.AgencyManagement.LIST_SUBMENU_AGENCY_MANAGEMENT_F24);
        }
        if(menu.equals(RISK_MANAGEMENT)){
            List<String> lstSubMenu = leftMenuList.getListSubMenu(RISK_MANAGEMENT);
            return lstSubMenu.equals(AGConstant.RiskManagement.LIST_SUBMENU_RISK_MANAGEMENT_F24);
        }
        ...
        if(menu.equals(MARKET_MANAGEMENT)){
            ...
            return lstSubMenu.equals(AGConstant.MarketsManagement.LIST_SUBMENU_HAS_SUSPEND_MARKETS_MANAGEMENT);
        }
        return false;
    }

    public void verifyListSubMenuDisplayCorrect() {
        List<String> lstMenu = Arrays.asList(AGENCY_MANAGEMENT, RISK_MANAGEMENT, REPORT, MARKET_MANAGEMENT);
