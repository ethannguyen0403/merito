...
public class QuickSearch extends LeftMenu {
    ...
    public DownLineListingPage clickDownLineListing()
    {
        ...
        DownLineListingPage page = new DownLineListingPage();
        page.waitingLoadingSpinner();;
        return page;
    }
    public ProfitAndLossPage clickProfitAndLoss()
    {
    ...
    public ClientLedgerPage clickClientLedger()
    {
        mtQuickSearchMenu.clickMenu(CLIENT_LEDGER);
        ClientLedgerPage page = new ClientLedgerPage();
        page.waitingLoadingSpinner();;
        return page;
    }
