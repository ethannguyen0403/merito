...
import agentsite.pages.all.report.components.UnsettleBetSportModeContainer;

import java.util.ArrayList;
import java.util.List;

public class UnsettledBetPage extends LeftMenu {
/*    public RadioButton rbLastBetMode = RadioButton.xpath("//app-unsettled-bet//input[contains(@id,'last-bets-mode')]");
  ...
  /*  public RadioButton rbAll = RadioButton.xpath("//input[@id='all']");
    ...
    public List<String> getFirstBetInfo(){
        ...
        data.add(competitionAndEvent.split(",")[0]);data.add(competitionAndEvent.split(",")[1]);
