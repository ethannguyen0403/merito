package agentsite.pages.all.agentmanagement.subuserlisting;
...
import static agentsite.common.AGConstant.AgencyManagement.SubUserListing.PERMISSIONS_ALL;

public class SubUserPopup extends BasePage {
