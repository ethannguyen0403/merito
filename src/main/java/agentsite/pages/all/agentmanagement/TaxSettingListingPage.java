...
public class TaxSettingListingPage extends LeftMenu {
   ...
   // public int fancyCol = 11;
    ...
    public void updateTaxSetting(String loginID,double soccerTax, double cricketTax, double tennisTax, double basketballTax,  double otherTax){
        ...
        String chbDownlinexPath = tblTax.getControlxPathBasedValueOfDifferentColumnOnRow(loginID,1,loginIDCol,1,null,chbCol,"input[@id='cItem']",false,false);
