...
import static agentsite.common.AGConstant.MarketsManagement.BlockUnblockEvent.TAB_DAYS;

public class EventBetSizeSettingsPage extends LeftMenu {
    ...
    public DialogPopup openErrorPopup(String eventID, String product){
