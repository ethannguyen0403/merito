...
public class EGTaxSettingsSection extends BaseElement {
    ...
    public EGTaxSettingsSection(By locator, String xpathExpression) {
        super(locator);
    ...
    public static EGTaxSettingsSection xpath(String xpathExpression) {
        return new EGTaxSettingsSection(By.xpath(xpathExpression), xpathExpression);
    }
