...
public class NewUIProfitAndLoss extends ProfitAndLoss {
    public void verifyUIDisplayCorrect(boolean isLevelLoginPO) {
        ...
        Assert.assertEquals(lblTo.getText(), LBL_TO, "FAILED! To label is incorrect");
        ...
        Assert.assertEquals(lblUplineProfitAndLoss.getText(), String.format("%s%s%s",LBL_UPLINE_PROFIT_AND_LOST, " Currency ", currency), "FAILED Upline profit and lost message is incorrect");
        Assert.assertEquals(lblDownlineProfitAndLoss.getText(), String.format("%s%s%s",LBL_DOWNLINE_PROFIT_AND_LOST," Currency ", currency), "FAILED Downline profit and lost message is incorrect");
        Assert.assertEquals(tblUplineProfitAndLoss.getHeaderNameOfRows(), TBL_UPLINE_TABLE_NEWUI, "FAILED! Upline table is incorrect");
        Assert.assertEquals(tblDownLineProfitAndLoss.getHeaderNameOfRows(), TBL_DOWNLINE_TABLE_NEWUI, "FAILED! Dowline tablie is incorrect");
    }
}
