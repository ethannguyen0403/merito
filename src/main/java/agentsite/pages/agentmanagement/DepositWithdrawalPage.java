...
//        }
//        depositWithdraw.btnSubmit.click();
//        waitingLoadingSpinner();
//    }
...
//            expectedMainBalance = DoubleUtils.roundUpWithTwoPlaces(mainBalance) - amount;
//        }
//        if (depositWithdraw.getLabelText("lblLoginAccountAvailableBalance").contains(String.format(Locale.getDefault(), "%,.2f", expectedMainBalance))) {
//            System.out.println(String.format("PASSED! Main Available Balance correct Actual is %s expected is %s",
//                    depositWithdraw.getLabelText("lblLoginAccountAvailableBalance"), String.format(Locale.getDefault(), "%,.2f", expectedMainBalance)));
//            return true;
//        }
//        return false;
//    }
