...
public class OldUIBetSettingListing extends BetSettingListing {
    ...
    private int decimalCricketCol = 14;
    private int tennisCol = 15;
    private int basketballCol = 16;
    private int otherCol = 17;
    private int updateStatusCol = 18;
    ...
    public List<ArrayList<String>> defineActualDataForOneAccount(HashMap<String, Boolean> sportList, double minBet, double maxBet, double maxLiabilityPerMarket, double maxWinPerMarket) {
        ...
        if (minBet != -1) {
            ...
            if(sportList.get("Decimal Cricket")) {lstExpectedData.get(0).set(decimalCricketCol - 1, String.format("%,.2f", minBet));}
        }
        if (maxBet != -1) {
            ...
            if(sportList.get("Decimal Cricket")) { lstExpectedData.get(1).set(5, String.format("%,.2f", maxBet)); }
            if(sportList.get("Bookmaker")) { lstExpectedData.get(1).set(6, String.format("%,.2f", maxBet)); }
            if(sportList.get("Tennis")) { lstExpectedData.get(1).set(7, String.format("%,.2f", maxBet)); }
            if(sportList.get("Basketball")) { lstExpectedData.get(1).set(8, String.format("%,.2f", maxBet)); }
            if(sportList.get("Other")) { lstExpectedData.get(1).set(9, String.format("%,.2f", maxBet)); }
        }
        if(maxLiabilityPerMarket != -1) {
            ...
            if(sportList.get("Decimal Cricket")) { lstExpectedData.get(2).set(5, String.format("%,.2f", maxLiabilityPerMarket)); }
            if(sportList.get("Bookmaker")) { lstExpectedData.get(2).set(6, String.format("%,.2f", maxLiabilityPerMarket)); }
            if(sportList.get("Tennis")) { lstExpectedData.get(2).set(7, String.format("%,.2f", maxLiabilityPerMarket)); }
            if(sportList.get("Basketball")) { lstExpectedData.get(2).set(8, String.format("%,.2f", maxLiabilityPerMarket)); }
            if(sportList.get("Other")) { lstExpectedData.get(2).set(9, String.format("%,.2f", maxLiabilityPerMarket)); }
        }
        if(maxWinPerMarket != -1) {
            ...
            if(sportList.get("Decimal Cricket")) { lstExpectedData.get(3).set(5, String.format("%,.2f", maxWinPerMarket)); }
            if(sportList.get("Bookmaker")) { lstExpectedData.get(3).set(6, String.format("%,.2f", maxWinPerMarket)); }
            if(sportList.get("Tennis")) { lstExpectedData.get(3).set(7, String.format("%,.2f", maxWinPerMarket)); }
            if(sportList.get("Basketball")) { lstExpectedData.get(3).set(8, String.format("%,.2f", maxWinPerMarket)); }
            if(sportList.get("Other")) { lstExpectedData.get(3).set(9, String.format("%,.2f", maxWinPerMarket)); }
        }
