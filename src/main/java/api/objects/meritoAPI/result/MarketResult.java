...
public class MarketResult extends ResultObject {
    ...
    public List<Market> getMarketList() {return _marketList;}

    public void setMarketList(List<Market> val) {_marketList = val;}
    ...
    public static class Builder {
        ...
        public MarketResult build() { return new MarketResult(this); }
    }
