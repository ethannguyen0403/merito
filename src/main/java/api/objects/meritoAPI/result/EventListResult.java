...
public class EventListResult extends ResultObject {
    ...
    public List<Event> getEventList() {return _eventList;}

    public void setEventList(List<Event> val) {_eventList = val;}
    ...
    public static class Builder {
        ...
        public EventListResult build() { return new EventListResult(this); }
    }
