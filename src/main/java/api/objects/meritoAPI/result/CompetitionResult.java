...
public class CompetitionResult extends ResultObject {
    ...
    public List<Competition> getCompetitionList() {return _competitionList;}
    public void setCompetitionList(List<Competition> val) {_competitionList = val;}
    ...
    public static class Builder {
        ...
        public CompetitionResult build() { return new CompetitionResult(this); }
    }
