...
public class BetSettingGroup {
    ...
    public void setMinBet(double val) {_minBet = val;}
    public double getMaxBet() {
        return _maxBet;
    }
    public void setMaxBet(double val) {_maxBet = val;}
    public double getMaxMinPerMatch() {
        return _maxWinPerMatch;
    }
    public void setMaxMinPerMatch(double val) {_maxWinPerMatch = val;}
    public double getMaxBetPerMatch() {
        return _maxBetPerMatch;
    }
    public void setMaxBetPerMatch(double val) {_maxBetPerMatch = val;}
    ...
    public static class Builder {
        ...
        public BetSettingGroup build() { return new BetSettingGroup(this); }
    }
