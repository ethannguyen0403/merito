...
public class NewUIProfitAndLossContainer extends ProfitAndLossContainer{
    ...
    public String getStartDate(){return lblStartDate.getText();}

    public String getEndDate(){return lblEndDate.getText();}

    public String getNote(){return lblNote.getText();}
    public String getLoadReport(){return btnLoadReport.getText();}
    public List<String> getReportHeader(){return tblSport.getColumnNamesOfTable();}
    public boolean isExportButtonDisplay(){return btnExport.isDisplayed();}
}
