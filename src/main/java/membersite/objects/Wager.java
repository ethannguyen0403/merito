...
public class Wager {
    ...
    public int getBetID(){return _betID;}
    public String getBetType(){return _betType ;}
    public String getBettingType(){return _bettingType;}
    public double getLiability(){return _liability;}
    ...
    public String getMarketType(){return _marketType;}
    public double getOdds(){return _odds;}
    public int getOrderID(){return _orderID;}
    public double getPayout(){return _payout;}
    public String getPersistenceType(){return _persistenceType;}
    public double getProfit(){return  _profit;}
    public String getRunnerName(){return _runnerName;}
    public String getNewOdds(){return _selectionId;}
    public double getStake(){return _stake;}
    ...
    public void setHandicap(int val){
        _handicap = val;}
    public void setLiability(double val){_liability =val;}
    public void setHandicap(double val){_handicap =val;}
    ...
    public void setMarketType(String val){
        _marketType = val;}
    public void setOdds(double val){_odds=val;}
    public void setOdrerID(int val){_orderID =val;}
    public void setPayout(double val){_payout =val;}
    public void setPersistenceType(String val){_persistenceType = val;}
    public void setProfit(double val){_profit =val;}
    ...
    public void setSelectionID(String val){
        _selectionId = val;}
    public void setStake(double val){_stake = val;}
    ...
    public static class Builder {
        ...
        public Wager build() { return new Wager(this); }
