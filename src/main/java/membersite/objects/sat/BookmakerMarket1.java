...
public class BookmakerMarket1 {
    ...
    public void setMarketStatus(String val) {
        _marketStatus = val;
    }
    ...
    public List<BookmakerSelection> getBMSelections() {
        return _bmSelections;
    }
    ...
    public void setRebateRatio(int val) {
        _rebateRatio = val;
    }

    public String getMinMaxSetting() {
        return _minMaxSetting;
    }

    public void setMinMaxSetting(String val) {
        _minMaxSetting = val;
    }
    ...
    public void setRatingExposure(int val) {
        _ratingExposure = val;
    }
    ...
    public void setBMSelection(List<BookmakerSelection> val) {
        _bmSelections = val;
    }

    public void setMarketId(int val) {
        _marketID = val;
    }
    ...
    public static class Builder {
        ...
        public Builder bmSelection(List<BookmakerSelection> val) {
            _bmSelections = val;
            return this;
        }

        public Builder rebateRatio(int val) {
            _rebateRatio = val;
            return this;
        }

        public Builder minMaxSetting(String val) {
            _minMaxSetting = val;
            return this;
        }
        ...
        public BookmakerMarket1 build() {
            return new BookmakerMarket1(this);
        }
    }
}
