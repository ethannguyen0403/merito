...
public class BookmakerMarket {
    ...
    public Link getBtnNo(){return _lnkOdds;}
    ...
    public void setBtnNo(Link val){_lnkOdds = val;}
    ...
    public static class Builder {
        ...
        public Builder btnNo(Link val){
            _lnkOdds =val; return this;}
        public BookmakerMarket build() { return new BookmakerMarket(this); }
