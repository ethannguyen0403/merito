...
public class EvolutionPageWhiteCliffTest extends BaseCaseTest {
    ...
    public void Casino_Test_TC20225(){
        ...
        Assert.assertTrue(evolutionWhiteCliffPage.iconLogo.isDisplayed(),"FAILED! Title Evolution casino is not correct");
    ...
    public void Casino_Test_TC20244(String BOLoginId, String BOLoginPwd, String currency) throws Exception {
        ...
        evolutionWhiteCliffPage.openGameByIndex("1");
        double balanceCasino = evolutionWhiteCliffPage.getBalanceInGame();
    ...
    public void Casino_Test_TC20255() {
        ...
        Assert.assertTrue(!evolutionWhiteCliffPage.iconLogo.isDisplayed(),"FAILED! Evolution (WhiteCliff) game is displayed");
        log("INFO: Executed completely");
    }
}
