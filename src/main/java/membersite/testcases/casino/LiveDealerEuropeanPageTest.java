...
public class LiveDealerEuropeanPageTest extends BaseCaseTest {
    ...
    public void Casino_Test_TC20228(){
        ...
        List<String> productsList = liveDealerEuropeanPage.getProductsList();
    ...
    public void Casino_Test_TC20237(){
        ...
        liveDealerEuropeanPage.openRandomGame();
    ...
    public void Casino_Test_TC20248(String BOLoginId, String BOLoginPwd, String currency) throws Exception {
        ...
        liveDealerEuropeanPage.openGameByIndex(1);
        double balanceCasino = liveDealerEuropeanPage.getCasinoBalance();
    ...
    public void Casino_Test_TC20259(){
        ...
        Assert.assertFalse(liveDealerEuropeanPage.lnkProductsList.isDisplayed(), "FAILED! Live Dealer European is able to access by URL while it's inactivated");
        log("INFO: Executed completely");
    }
}
