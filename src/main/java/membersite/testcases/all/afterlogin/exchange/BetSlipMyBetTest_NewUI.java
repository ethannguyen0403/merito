...
public class BetSlipMyBetTest_NewUI extends BaseCaseMerito {
    /**
     * @title Validate Odds display correct when clicking on the corresponding odds of all selection
