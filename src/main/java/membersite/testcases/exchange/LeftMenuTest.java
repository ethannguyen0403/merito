...
//        memberHomePage.leftMenu.expandLeftMenu();
//        log("Verify 1. Left menu is expanded");
//        Assert.assertTrue(memberHomePage.leftMenu.imgLeftMenu.getAttribute("src").contains(String.format(MemberConstants.Header.LEFT_MENU_ICON_EXPAND,skinName)),
