...
public class OddsSectionTest extends BaseCaseMerito {
     ...
     */
    @Test(groups = {"smoke"})
    public void FE_OddsSection_TC003() {
     ...
     */
    @Test(groups = {"smoke"})
    public void FE_OddsSection_TC007() {
        ...
        String marketNameExpected = memberHomePage.marketContainerControl.getTitle();
        Assert.assertTrue(memberHomePage.marketContainerControl.isDisplayed(), "ERROR! Market page not display after click on the event");
     ...
     */
    @Test(groups = {"smoke"})
    public void FE_OddsSection_TC008() {
        ...
        List<String> lstEvent = memberHomePage.eventContainerControl.getAllEventHighlight();
        ...
        for (String event : lstEvent) {
            ...
            Assert.assertEquals(marketName.startsWith(event), String.format("ERROR! Match odds market not active by default, Currently is %s", marketName));
     ...
     */
    @Test(groups = {"smoke"})
    public void FE_OddsSection_TC015() {
