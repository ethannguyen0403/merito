...
public class SATPlaceBetFunctionTest extends BaseCaseMerito {
  /*  *//**
    ...
    public void SAT_Place_Bet_Function_TC001(){
        ...
        Market market = page.marketContainerControl_SAT.getMarket(event,1,true);
...
/*
    ...
    public void SAT_Place_Bet_Function_TC002(){
        ...
        String expectedProfit = String.format("%.2f",(Double.parseDouble(wagers.get(0).getOdds())-1)*Double.parseDouble(minBet));
        AccountBalance balanceExpected = page.getUserBalanceSAT();
        String expectedBalance = String.format("%.2f", Double.parseDouble(balance.getBalance()) - Double.parseDouble(wagers.get(0).getLiability()));
    ...
    public void SAT_Place_Bet_Function_TC003(){
        ...
        String expectedLiability = String.format("%.2f",(Double.parseDouble(wagers.get(0).getOdds())-1)*Double.parseDouble(minBet));
...
*//*
    ...
    @TestRails(id="559")
     ...
     public void SAT_Place_Bet_Function_TC005(){
            ...
            try {
                ...
                Market market = page.marketContainerControl_SAT.getMarket(event,1,false);
                market.getBtnOdd().click();
    ...
    *//**
    ...
    public void SAT_Place_Bet_Function_TC007(){
        ...
        market = page.marketContainerControl_SAT.getMarket(event,1,true);
        market.getBtnOdd().click();
    ...
    *//**
    ...
    public void SAT_Place_Bet_Function_TC008(){
        ...
        try {
            Event event = page.getEvent(false,false,20,2);
            if(Objects.isNull(event)) {
                log("DEBUG: There is no event available");
                return;
            }
    ...
    *//**
    ...
    public void SAT_Place_Bet_Function_TC009(){
        ...
        SportPage page = memberHomePage.navigateSportMenu("Cricket",SportPage.class);
        try {
            Event event = page.eventContainerControl_SAT.getEvent(false,false,3,1);
            if(Objects.isNull(event)) {
                log("DEBUG: There is no event available");
                return;
            }
    ...
    *//**
    ...
    public void SAT_Place_Bet_Function_TC011(){
        log("@title: Validate can NOT place unmatched Lay bet for Horse Racing");
        boolean isBack = false;

        String minBet = BetUtils.getMinBet(SportPage.Sports.OTHER, SportPage.BetType.LAY);
        //String expectedLiability = String.format("%.2f",(Double.parseDouble(odds)-1)*Double.parseDouble(minBet));
        ...
        *//*
        ...
        log("Step 3. Update odd to 1.01, Input valid stake");
        log("Step 4. Click place bet");
        page.betSlipControl.placeBet(odds,minBet);
        String actualError = page.myBetControl.getPlaceBetErrorMessage();
    ...
    *//**
    ...
    public void SAT_Place_Bet_Function_TC021(){
        ...
        try {
            ...
            // page.lblBalance.isTextDisplayed(expectedBalance,3);
            AccountBalance balanceExpected = page.getUserBalanceSAT();
            String expectedBalance = String.format("%.2f", Double.parseDouble(balance.getBalance()) - Double.parseDouble(wagers.get(0).getLiability()));
    ...
    *//**
    ...
    public void SAT_Place_Bet_Function_TC022(){
        ...
        try {
            ...
            log("Step 2. Click on any Lay odds");
            Market market = page.marketContainerControl_SAT.getMarket(event,1,false);
            List<String> beforeForeCast = page.marketContainerControl_SAT.getForeCast();
            String maxBeforeForeCast = page.getMaxLiabiliy(beforeForeCast);
            market.getBtnOdd().click();
            ...
            page.betSlipControl.placeBet(odds,minBet);
            List<Order> wagers =page.myBetControl.getOrder(false,false,1);
            List<String> expectedForeCast = page.marketContainerControl_SAT.calculateForecast(beforeForeCast,1,false,minBet,expectedLiability);
            String maxAfterForeCast = page.getMaxLiabiliy(expectedForeCast);
            ...
            if(maxAfterForeCast.equalsIgnoreCase(maxBeforeForeCast))
            {
                expectedBalance = balance.getBalance();
                expectedExposure = balance.getExposure();
            }
            else{
                expectedBalance = String.format("%.2f",Double.parseDouble(balance.getBalance()) - Double.parseDouble(wagers.get(0).getLiability()));
                expectedExposure = String.format("%.2f",Double.parseDouble(balance.getExposure())-Double.parseDouble(wagers.get(0).getLiability()));
            }
            Assert.assertEquals(balanceExpected.getBalance(),expectedBalance,"Balance update incorrectly after place bet");
    ...
    *//**
    ...
    @Test(groups = {"smoke"})
    @Parameters({"isCredit"})
    public void SAT_Place_Bet_Function_TC023(boolean isCredit){
