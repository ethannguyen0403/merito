 ...
 */
public class MarketOddControl extends BaseElement {
	...
	private MarketOddControl(By locator, String xpath, boolean isMatchOdds) {
		super(locator);
		_xpath = xpath;
		_isMatchOdds = isMatchOdds;

	}
	public static MarketOddControl xpath(String xpathExpression, boolean isMatchOdds) {
		return new MarketOddControl(By.xpath(xpathExpression), xpathExpression, isMatchOdds);
	}
